...
public class EmployeAcceptanceTest {
    ...
    @Step("Le commercial de matricule <matricule> obtiens bien une performance de <performance>.")
    ...
    public void insertEmployeWithPerformance(String prenom, String nom, String matricule, Integer performance) throws EmployeException {
